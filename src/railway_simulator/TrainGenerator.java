...
//	private final Random rand = new Random();
	...
	private RailwaySection startPos;
	
	public TrainGenerator(RailwaySection rs, Railway r, DelayGenerator delayGenerator,Train train) {
		startPos = rs;
		this.r = r;
	...
	public void run() {
		try {
			...
			Thread.sleep(delay);
			new Thread(new TrainMover(train.getSpeed(),r.getRailway()[0],r)).start();
